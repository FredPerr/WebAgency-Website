...
AdvertisementArticle.getLayout = function getLayout(page: React.ReactElement) {
    return (
        <ArticleLayout
            name="Fonctionnement de notre service de publicité numérique"
            subtitle="Quels sont les coûts? Est-ce qu'un petit budget peu être profitable avec de la publicité? Combien de temps avant d'avoir des résultats? Quels réseaux sociaux conviennent pour mon entreprise, ..."
            readTime={5}
...
export default AdvertisementArticle
