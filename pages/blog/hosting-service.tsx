...
HostingArticle.getLayout = function getLayout(page: React.ReactElement) {
    return (
        <ArticleLayout
            name="Fonctionnement de notre service de gestion de l'hébergement"
            subtitle="Quels sont les coûts? Quel est le niveau de sécurité et de fiabilité? Combien de clients mon site peut-il supporter? Quels sont les éléments techniques de l'hébergement, ..."
            readTime={5}
            videoUrlFrench="https://www.youtube.com/embed/xcJtL7QggTI"
            videoUrlEnglish="https://www.youtube.com/embed/xcJtL7QggTI"
        >
            {page}
        </ArticleLayout>
    )
